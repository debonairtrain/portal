...
$rst_1 = '<h5 style="border-bottom:solid thin #CCC; margin-top:5px ">O-LEVEL RESULT INFORMATION</h5>';




if (applicant_olevel_type_exist($con, $u, $type = 1)) {
	$rst_1 .= get_applicant_olevel($con, $u);	 
 }		 
...
<div align="center"> $output </div>
 ...
 <table cellspacing="1"  border="1" cellpadding="1" style="font-size:11px;">
			  ...
			  <td width="20%"> GENDER : $gender</td>
			   ...
			   <td width="50%"> DATE OF BIRTH(DAY/MONTH/YEAR): $day/$month/$year</td>
