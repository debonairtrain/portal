...
<div class="card col-md-8">
  <div class="card-header">
    <h4 class="text-primary text-center"><?php echo get_user_matric_number($con, $user_id); ?></h4>
  </div>
  <div class="card-body">
    <div class="row">
      <div class="col-md-4">
      ...
      <div class="col-md-8">
        ...
        <p>School: <strong><?php echo get_school_title_by_id($con, $school_id); ?></strong></p>
        <p>Department: <strong><?php echo get_department_title($con, $department_id); ?></strong></p>
        <p>Programme: <strong><?php echo get_programme_title($con, $programme_id); ?></strong></p>
