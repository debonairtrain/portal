...
if(isset($_GET['iid']))
{
	...
	$a_no = get_user_matric_number($con,$user_id);
														 ...
														 <script>
														   function payWithPaystack(){
														     ...
														     var handler = PaystackPop.setup({
														       key: 'pk_test_8344d16547656a45509e85e1cc2c812486e9225a',
														       email: email,
														       amount: amount *100,
														       currency: "NGN",
														       ...
														       callback: function(response){
														          alert('Payment complete! Reference: ' + response.reference);
																			 //window.location = "https://localhost/ofusware_portals/portals/verify_transaction?reference=" + response.reference;
														       },
														       onClose: function(){
														           swal('window closed');
														       }
