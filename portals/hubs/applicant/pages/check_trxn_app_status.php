              ...
              <div class="card-body">
					...
					if($response_code == '01' || $response_code == '00')
					{
					 ...
					 if(has_paid_applicant_fee($con, $student_id,$session))
					 {
					 ...
					 else
					 {
								 ...
								 $qry44="INSERT INTO `applicants_fee_payments`(`id`, `programme_type_id`, `department_id`, `programme_id`,
						...
						$transaction_type = 1; //returning students
