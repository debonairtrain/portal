								 ...
								 $m_no = get_user_application_number($con, $user_id);
								  ...
								  {//begin if interswitch rep
								 	   ...
								 	   if($response_code == '00' || $response_code == '01')
								 	   {
								 								...
								 								if(has_paid_applicant_fee($con, $user_id,$session))
								 								{

								 											$msg ="&nbsp;&nbsp;&nbsp;&nbsp;Application fee payment for this session has been made already. Please click on payment tab to print receipt";
								 											header("Location: view_invoice?info=".urlencode($msg)."&qlk=".md5(2)."&auth=".sha1(md5(2))."&iid=".$iid);
								 								}
								 								else
								 								{
								 								 ...
								 								 VALUES (NULL,'$programme_type','$department','$programme','$session','$invoice_to','1', '$iid','$invoice_amount',NOW())";
								 								  ...
								 								  if($rrr1)//mysqli_affected_rows($dbc)
								 								  {
								 										  ...
								 										  else
								 										  {
								 											...
								 											header("Location: view_invoice?error=".urlencode($msg)."&qlk=".md5(2)."&auth=".sha1(md5(2))."&iid=".$iid);
								 			  ...
								 			  if($rrr != '')
								 			  {
								 			    ...
								 			    if($rrr != '' && $orderID != '')
								 			    {
								 					  ...
								 					  else
								 					  {
								 						 ...
								 						 header("Location: view_invoice?error=".urlencode($msg)."&qlk=".md5(2)."&iid=".$iid);
