...
//get current session
 ...
 <br><br><br><br><br><br><br><br>
    ...
    <ul class="breadcrumb">
        ...
        <li class="active" >Acceptance fee payments<span class="divider"></span> </li>
    </ul>
...
<div class="well">
    ...
    <?php
	if(!has_paid_applicant_fee($con, $applicant_id))
	{ ?>
    ...
    <button class="btn btn-login btn-green" data-toggle="tooltip" data-placement="top" title="Click here to Print / Download Payment Receipt"><i class="glyphicon glyphicon-print"> </i> Print / Download Receipt</button>
...
-->
                                        ...
                                        <?php echo view_invoices($con, $applicant_id, $invoice_type = 0,$session); ?>
