...
if(isset($_GET['invoice'])){
    ...
    include_once('scripts/functions.php');
     $applicant_id = get_invoice_invoice_to($con, $invoice_id);
...
$output = '';
 ...
 $output .= '<h5 class="text-info"  style="color:#468C00; font-weight:normal">P A Y M E N T D E T A I L S - S L I P  </h5>';
...
<div align="center"> $output </div>
 ...
 <table cellspacing="1"  border="1" cellpadding="1" style="font-size:11px;">
			  ...
			  <tr>
			  <td width="30%"> COUNTRY OF ORIGIN: NIGERIA</td>
 ...
 <br><br>
  ...
  <h6 style="border-bottom:solid thin #CCC">PAYMENT DETAILS</h6>
 <table cellspacing="1"  border="1" cellpadding="1" style="font-size:11px;">
			  
			  <tr><td width="50%" style="font-seize:20px; font-weight: bold;"> PAYMENT FOR : $invoice_desc</td>
			      <td width="50%" style="font-seize:20px; font-weight: bold;"> AMOUNT : <b> $invoice_amount</b></td>
			  </tr> 
			
			   <tr>
			   
			  <td width="40%" style="font-seize:20px; font-weight: bold;"> ACCOUNT NUMBER: 2038066737</td>
			   <td width="40%" style="font-seize:20px; font-weight: bold;"> ACCOUNT NAME : GREAT SUCCESS COLLEGE OF HEALTH SCIENCES AND TECHNOLOGY GWADA</td>
			    <td width="20%" style="font-seize:20px; font-weight: bold;"> BANK NAME : FIRST BANK</td>
			  </tr> 
