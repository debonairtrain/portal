	...
	$sqlmg=mysqli_query($con, "SELECT applicant.id, applicant.school_applied, applicant.department_applied, applicant.programme_applied, applicant.application_number,
		 applicant.state_id, applicant.lga_id, applicant.first_name, applicant.last_name, applicant.middle_name, applicant.phone_no, applicant.gender,  applicant.email,
		  ...
		  WHERE applicant.programme_applied = '$id' AND applicant.id = applicants_fee_payments.applicant_id AND applicant.session_id='$session'
    ...
    <div class="modal fade" id="exampleModalScrollable" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalScrollableTitle">Add Applicant</h5>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                          </button>
                        </div>
                        <div class="modal-body text-left">
                          <form action="#" id="add_applicant" method="post">
                              <div class="form-row">
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-12 col-md-6">
                            ...
                            <label for="inputState" class="form-label">Date of Birth</label>
                             <input type="date" class="form-control" placeholder="Date of Birth" name="date" value="<?php if(isset($_POST['c_password'])) echo($_POST['c_password'])?>" required>
                        </div>
                        <div class="col-sm-12 col-md-6">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="register-submit" id="saving_register">
                          <button type="submit"  class="btn btn-primary" style="width:100%; background-color:#4a6350; border: none; padding-top:10px; padding-bottom:10px; height:50px;"><span>Add Applicant</span></button>
                        </div>
...
$(document).ready(function(e){
    ...
    $("#add_applicant").submit(function(event){
      event.preventDefault(); //prevent default action
      var post_url = "php/add_applicant.php"; //get form action url
      var request_method = $(this).attr("method"); //get form GET/POST method

      $("#output_register").html('<div style="margin-top:10px"><center>Adding Applicant Data, please wait...<br/><img src="../assets/images/ajax-loader1.gif" width="10%"/></center></div>');
