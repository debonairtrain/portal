...
<!-- Modal -->
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="inbox-body no-pad">
															...
															<div class="compose-mail">
																<form method="post" id="add_accept_fee_setup">
               ...
               $("#add_accept_fee_setup").submit(function(event){
                 event.preventDefault(); //prevent default action
                 var post_url = "php/finance/add_accept_fee_setup.php"; //get form action url
                 var request_method = $(this).attr("method"); //get form GET/POST method

                 $("#accept_error").html('<div style="margin-top:10px"><center>Adding details, please wait...<br/><img src="assets/images/ajax-loader1.gif" width="10%"/></center></div>');
                 ...
                 var form_data = new FormData(this); //Creates new FormData object
                   ...
                   $.ajax({
                     ...
                     if(response==1){
                       ...
                       window.location.href = "dashboard?hubs=accept_fee_setup&Successfully Added";
                     }else{
                       swal(response);
                  ...
                  function delete_school(id)
                  {
                    if(confirm("Do you  really want to proceed?"))
                     {
                       $.post("php/finance/delete_accept_fee_setup.php",{id:id},
