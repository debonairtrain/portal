...
<ul class="breadcrumb">
<li class="breadcrumb-item active">Archive Application Fee Setup</li>
</ul>
</div>
</div>
</div>
                          ...
                          <div class="card-body ">
														<div class="row">
															<div class="col-md-6 col-sm-6 col-6">
																<div class="btn-group">
																	<a href="dashboard?hubs=app_fee_setup" id="addRow" class="btn btn-info" >
...
<script type="text/javascript">
							function delete_school(id)
							{
								if(confirm("Do you  really want to restore it?"))
								 {
									 $.post("php/restore_app_fee.php",{id:id},
