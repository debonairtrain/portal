...
<ul class="breadcrumb">
<li class="breadcrumb-item active">Verify School Fee</li>
</ul>
</div>
</div>
</div>
...
<div class="card-body">
  <div class="row">
    ...
    <li class="list-group-item btn btn-info col-md-12" style="text-align:center;">
        School Fee Status Verification
    </li>
        ...
        <?php
          if(isset($_POST['search']))
          {
            ...
            @$invoice_id = mysqli_real_escape_string($con, $_POST['invoice_id']);
              ...
              $verify = mysqli_query($con, "SELECT student_id,invoice_id FROM school_fee_payments WHERE invoice_id='$invoice_id'
                                    AND session='$session'");
                if($verify){
                      ...
                      $row=mysqli_fetch_assoc($verify);
                        $invoice_id=$row['invoice_id'];
                          ...
                          echo '<div class="row col-md-12">
                            <div class="col-md-10">
                              <a href="dashboard?hubs=view_student&id='.md5("profile").'&xd='.$row['id'].'" target="_new" class="btn btn-success" name="view">View Profile</a>
