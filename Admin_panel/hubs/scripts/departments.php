                            ...
                            <div class="card-body ">
                              <div class="row">
                                <div class="col-md-6 col-sm-6 col-6">
                                  <div class="btn-group">
                                    <a href="dashboard?hubs=new_department" id="addRow" class="btn btn-info" >
                                      Add New <i class="fa fa-plus"></i>
                                    </a>
                                  </div>
                                  <div class="btn-group">
                                    <a href="dashboard?hubs=archive_department" id="addRow" class="btn btn-warning" >
                                      Archive <i class="fa fa-fw fa-times"></i>
                                    </a>
                                  </div>
                                </div>
  														...
  														<div class="col-md-12">
  															<?php
  															//query the database
  															$q = "SELECT * FROM departments WHERE department_status='1'
  																	ORDER BY title ASC";
  															...
  															{//show table
  												              ...
  												              <th>Action</th>
  																...
  																while($row = mysqli_fetch_array($r,MYSQLI_ASSOC))
  																{
  																	...
  																	$output .= '<td>
                                    <div class="actions">
                                    <a href="dashboard?hubs=edit_department&id='.$row['id'].'" id="'.$id.'" class="btn btn-sm bg-success-light me-2">
...
<script type="text/javascript">
             function delete_school(id)
             {
               if(confirm("Do you  really want to proceed?"))
                {
                  $.post("php/delete_department.php",{id:id},
