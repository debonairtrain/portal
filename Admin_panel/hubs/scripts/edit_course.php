...
<div class="card-body">
  <div class="row">
                          ...
                          ?>
                          <div class="card-body ">
                            <form action="" method="post" id="edit_course">
              				...
              				<label for="code" class="col-sm-2 col-form-label text-right">Code :
              					...
              					<div class="col-sm-10">
              						...
              						placeholder="Code " value="<?php echo $code;?>" class="form-control required" required />
											...
											<div class="form-group row">
              				<label for="code" class="col-sm-2 col-form-label text-right">Unit :
              				</label>
              					<div class="col-sm-10">
              						<input id="Code" name="unit" type="text"
              						placeholder="Code " value="<?php echo $unit;?>" class="form-control required" required />
              					</div>
                      </div>
											<div class="form-group row">
											<label for="code" class="col-sm-2 col-form-label text-right">Core/Elective :
											</label>
												<div class="col-sm-10">
											...
											<div class="form-group row">
											<label for="code" class="col-sm-2 col-form-label text-right">Semester :
											</label>
												<div class="col-sm-10">
                      ...
                      <div class="form-group row">
						...
						<div id="saving_register" >
							<center><button type="submit" class="btn btn-info" >Submit </button>
								<a href="dashboard?hubs=courses" type="submit" class="btn btn-warning" >Calcel </a>
							</center>
						</div>
            ...
            <script type="text/javascript">
                ...
                $("#edit_course").submit(function(event){
                  ...
                  var post_url = "php/edit_course.php"; //get form action url
