...
<div class="card-body">
  <div class="row">
                          ...
                          ?>
                          <div class="card-body ">
                            <form action="" method="post" id="edit_department">
                      ...
                      <div class="form-group row">
						...
						<div id="saving_register" >
							...
							<a href="dashboard?hubs=epartments" type="submit" class="btn btn-warning" >Calcel </a></center>
						</div>
          ...
          <script type="text/javascript">
              ...
              $("#edit_department").submit(function(event){
                ...
                var post_url = "php/edit_department.php"; //get form action url
