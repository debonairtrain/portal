                            ...
                            <div class="card-body ">
                              <div class="row">
                                <div class="col-md-6 col-sm-6 col-6">
                                  <div class="btn-group">
                                    <a href="dashboard?hubs=new_programme" id="addRow" class="btn btn-info" >
                                      Add New <i class="fa fa-plus"></i>
                                    </a>
                                  </div>
                                  <div class="btn-group">
                                    <a href="dashboard?hubs=archive_programmes" id="addRow" class="btn btn-warning" >
                              ...
                              <div class="col-md-12">
  												<?php
  												//query the database
  												$q = "SELECT * FROM programmes WHERE programme_status='1'
  														ORDER BY title ASC";
                              ...
                              $output .= '<td>
                                            <div class="actions">
                                            <a href="dashboard?hubs=edit_programme&id='.$row['id'].'" id="'.$id.'" class="btn btn-sm bg-success-light me-2">
...
<script type="text/javascript">
             function delete_school(id)
             {
               if(confirm("Do you  really want to proceed?"))
                {
                  $.post("php/delete_programme.php",{id:id},
