...
<ul class="breadcrumb">
<li class="breadcrumb-item active">Add Acceptance Fee Setup</li>
</ul>
</div>
</div>
</div>
...
<div class="card-body">
  <div class="compose-mail">
                                      ...
                                      <?php echo select_department($con, $id='0')?>
                                        ...
                                        <a href="dashboard?hubs=accept_fee_setup" type="submit" class="btn btn-warning btn-sm" name="button"><i
                                  ...
                                  <div id="login_out">
							                ...
							                $("#add_accept_fee_setup").submit(function(event){
							                  ...
							                  var post_url = "php/add_accept_fee_setup.php"; //get form action url
