...
<ul class="breadcrumb">
<li class="breadcrumb-item active">Archive Departments</li>
</ul>
</div>
</div>
</div>
                          ...
                          <div class="card-body ">
														<div class="row">
															<div class="col-md-6 col-sm-6 col-6">
																<div class="btn-group">
																	<a href="dashboard?hubs=departments" id="addRow" class="btn btn-info" >
...
$select="SELECT * FROM departments WHERE department_status='2' ";
...
<script type="text/javascript">
							function delete_school(id)
							{
								if(confirm("Do you  really want to restore it?"))
								 {
									 $.post("php/restore_department.php",{id:id},
