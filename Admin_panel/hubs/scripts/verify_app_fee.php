...
<ul class="breadcrumb">
<li class="breadcrumb-item active">Verify Application Fee</li>
</ul>
</div>
</div>
</div>
...
<div class="card-body">
  <div class="row">
    ...
    <li class="list-group-item btn btn-info col-md-12" style="text-align:center;">
        Application Fee Status Verification
    </li>
        ...
        <?php
          if(isset($_POST['search']))
          {
            ...
            @$invoice_id = mysqli_real_escape_string($con, $_POST['invoice_id']);
              ...
              $verify = mysqli_query($con, "SELECT applicant_id,invoice_id FROM applicants_fee_payments WHERE invoice_id='$invoice_id'
                                    AND session='$session'");
                if($verify){
