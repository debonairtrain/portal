  ...
  <div class="row">
                    				...
                    				<label for="title" class="col-sm-2 col-form-label text-right">School :
                    					...
                    					<div class="col-sm-10">
      													<select class="form-control" name="school_id">
      															<?php echo select_faculty($con,$school_id='0')?>
      													</select>
      												</div>
                            </div>
                      <div class="form-group row">
                  ...
                  <div id="saving_register" >
      							<center>
      														<button type="submit" class="btn btn-info" >Submit </button>
																	<a href="dashboard?hubs=faculties" type="submit" class="btn btn-warning" >Calcel </a>
                    </center>
      						</div>
                  <div id="login_out">
                  </div>
                ...
                <script type="text/javascript">
                    ...
                    $("#add_faculty").submit(function(event){
                      ...
                      var post_url = "php/add_faculty.php"; //get form action url
                      ...
                      var form_data = new FormData(this); //Creates new FormData object
                        ...
                        $.ajax({
                          ...
                          if(response==1){
                            window.location.href = "dashboard?hubs=faculties&Successfully Added";
                          }else{
