<?php
  ...
  $q = "UPDATE `set_application_fee_payments` SET `programme_type_id`='$school', `department_id`='$department_id',
	 `programme_id`='$programme_id', `session`='$session',`title`='$title', `description`='$description',
